...
//the constructor of loginView containing GUI code
	public LoginView(LoginModel loginModel,LoginController loginController) {
		...
		Color foreColor= new Color(102, 102, 102);
		
		leftPanel.setBounds(0, 0, 460, 700);
		Color color2= new Color(54, 33, 89);
		...
		jLLogin.setBackground(new Color(110, 89, 222 ));
		...
		belowLabel = new JLabel("Human Resource Monitor");
